...
import com.example.vishistvarugeese.memory.FaceRecognitionActivity
import okhttp3.*
...
class FaceRecognitionActivity : AppCompatActivity() {
    ...
    fun onRegisterFaceClick(view: View?) {
        ...
        alert.setPositiveButton("TAKE PHOTO") { dialog, whichButton ->
...
// Change base URL to your upload server URL.
        service = Retrofit.Builder().baseUrl("http://192.168.43.110:5000/").client(client).build().create(Service::class.java)
